...
class ParserTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testMultisigOpReturnParser_send1() {
        $parser = new Parser();
        $counterparty_data = $parser->parseBitcoinTransaction(
            $this->getMultisigSendToP2SH()
        );
        PHPUnit::assertNotEmpty($counterparty_data);

        PHPUnit::assertEquals('send', $counterparty_data['type']);
        PHPUnit::assertEquals('12717MBviQxttaBVhFGRP1LxD8X6CaW452', $counterparty_data['sources'][0]);
        PHPUnit::assertEquals('3BKuhJXt5YD1Vz2UyD4Fz4XaqN894saJaQ', $counterparty_data['destinations'][0]);
        PHPUnit::assertEquals('TOKENLY', $counterparty_data['asset']);
        PHPUnit::assertEquals(100 * self::SATOSHI, $counterparty_data['quantity']);
    }

    // OP_RETURN send 5 TOKENLY from 3BKuhJXt5YD1Vz2UyD4Fz4XaqN894saJaQ to 1MCEtBB5X4ercRsvq2GmgysZ9ZDsqj8Xh7
    public function testMultisigOpReturnParser_send2() {
        $parser = new Parser();
        $counterparty_data = $parser->parseBitcoinTransaction(
            $this->getMultisigFromP2SH()
        );
        PHPUnit::assertNotEmpty($counterparty_data);

        PHPUnit::assertEquals('send', $counterparty_data['type']);
        PHPUnit::assertEquals('3BKuhJXt5YD1Vz2UyD4Fz4XaqN894saJaQ', $counterparty_data['sources'][0]);
        PHPUnit::assertEquals('1MCEtBB5X4ercRsvq2GmgysZ9ZDsqj8Xh7', $counterparty_data['destinations'][0]);
        PHPUnit::assertEquals('TOKENLY', $counterparty_data['asset']);
    ...
    public function testNumericAssetParser_enhanced_send1() {
        $parser = new Parser();
        $counterparty_data = $parser->parseBitcoinTransaction(
            $this->getEnhancedSend1()
        );
        PHPUnit::assertNotEmpty($counterparty_data);

        PHPUnit::assertEquals('send', $counterparty_data['type']);
        PHPUnit::assertEquals('SOUP', $counterparty_data['asset']);
        PHPUnit::assertEquals(7334 * self::SATOSHI, $counterparty_data['quantity']);
        PHPUnit::assertEquals('Hello memo', $counterparty_data['memo']);
        PHPUnit::assertEquals('48656c6c6f206d656d6f', $counterparty_data['memo_hex']);
    }

    public function testNumericAssetParser_enhanced_send2() {
        $parser = new Parser();
        $counterparty_data = $parser->parseBitcoinTransaction(
            $this->getEnhancedSend2()
        );
        PHPUnit::assertNotEmpty($counterparty_data);
        ...
        PHPUnit::assertEquals('LTBCOIN', $counterparty_data['asset']);
        PHPUnit::assertEquals(5 * self::SATOSHI, $counterparty_data['quantity']);
        PHPUnit::assertNull($counterparty_data['memo']);
        PHPUnit::assertNull($counterparty_data['memo_hex']);
    }
    ...
    protected function getMultisigSendToP2SH() {
        // OP_RETURN send 100 TOKENLY from 12717MBviQxttaBVhFGRP1LxD8X6CaW452 to 3BKuhJXt5YD1Vz2UyD4Fz4XaqN894saJaQ
        // d7490e205e910613d139de0e65da45ffe964724748e6cbdcdebce0b269eb6fc9
        return json_decode('{"hex":"","txid":"d7490e205e910613d139de0e65da45ffe964724748e6cbdcdebce0b269eb6fc9","size":262,"version":1,"locktime":0,"vin":[{"txid":"0a79ec29639e331d93fc07640b4f4f282b37626436e1619a31f59336636545b0","vout":2,"scriptSig":{"asm":"304402204c70ba7358d3075d5010f6f04f166d641c6e4d606816a76b81f7a083f8983c1b02206ed69c900c09643f992c6b81f93f84831034e28a950e4364a371671478c4dadf[ALL] 02f537f58066db27f8fa3df7527f99e9d9a09fda4a5622cb4071a475ce070d26f5","hex":"47304402204c70ba7358d3075d5010f6f04f166d641c6e4d606816a76b81f7a083f8983c1b02206ed69c900c09643f992c6b81f93f84831034e28a950e4364a371671478c4dadf012102f537f58066db27f8fa3df7527f99e9d9a09fda4a5622cb4071a475ce070d26f5"},"sequence":4294967295,"n":0,"addr":"12717MBviQxttaBVhFGRP1LxD8X6CaW452","value":0.0051043,"valueSat":510430}],"vout":[{"value":5.47e-5,"n":0,"scriptPubKey":{"asm":"OP_HASH160 69b352d2b9e19cccb82c8d4ab416c33b63f49762 OP_EQUAL","hex":"a91469b352d2b9e19cccb82c8d4ab416c33b63f4976287","reqSigs":1,"type":"scripthash","addresses":["3BKuhJXt5YD1Vz2UyD4Fz4XaqN894saJaQ"]}},{"value":0,"n":1,"scriptPubKey":{"asm":"OP_RETURN 1a7e2de77f8a67969b11a835b257f9e7d63105447a44d70bf1b01969","hex":"6a1c1a7e2de77f8a67969b11a835b257f9e7d63105447a44d70bf1b01969","type":"nulldata"}},{"value":0.0049496,"n":2,"scriptPubKey":{"asm":"OP_DUP OP_HASH160 0c1ab681d252eb6c99002d0a73303e9677b1b025 OP_EQUALVERIFY OP_CHECKSIG","hex":"76a9140c1ab681d252eb6c99002d0a73303e9677b1b02588ac","reqSigs":1,"type":"pubkeyhash","addresses":["12717MBviQxttaBVhFGRP1LxD8X6CaW452"]}}],"blockhash":"0000000000000000043a0cf470191216020313adc3ac80658da6314a2a6d1ffb","confirmations":3143,"time":1473481672,"blocktime":1473481672,"valueIn":0.0051043,"valueInSat":510430,"valueOut":0.0050043,"valueOutSat":500430,"fees":0.0001,"feesSat":10000}', true);

    }
    protected function getMultisigFromP2SH() {
        // OP_RETURN send 5 TOKENLY from 3BKuhJXt5YD1Vz2UyD4Fz4XaqN894saJaQ to 1MCEtBB5X4ercRsvq2GmgysZ9ZDsqj8Xh7
    ...
    protected function getEnhancedSend1() {
        return json_decode('{"hex":"","txid":"b9ef50731991198d01fcaf8d95faa24482e9714af7d5d21cada6c393e3428e49","hash":"b9ef50731991198d01fcaf8d95faa24482e9714af7d5d21cada6c393e3428e49","size":258,"vsize":258,"version":1,"locktime":0,"vin":[{"txid":"b70b452d674f40cd49c0873f4d52e7b7abfdd48e62e6caf8dd0b217e02696398","vout":2,"scriptSig":{"asm":"304402207f50d0f0cfa27edbbc43003d19579ff7d6a9a66e2a505e890eae156af26a7349022008628eb56bbf40f3f34cd044eeff4cc3024476126f58179c85fc1713bd0ac6b5[ALL] 034bf23d14fa8aa9e8ebfee6e0bf986fa36ad61434068b89b7a8801506ed5060bb","hex":"47304402207f50d0f0cfa27edbbc43003d19579ff7d6a9a66e2a505e890eae156af26a7349022008628eb56bbf40f3f34cd044eeff4cc3024476126f58179c85fc1713bd0ac6b50121034bf23d14fa8aa9e8ebfee6e0bf986fa36ad61434068b89b7a8801506ed5060bb"},"sequence":4294967295}],"vout":[{"value":0,"n":0,"scriptPubKey":{"asm":"OP_RETURN 66d70748b84f49ba52e6966f66952a8b72923d688cea75f4795ebda19bbe67b5cfee4b244003e964d91dfb2751a9fadc7d8a4d28f7eb8c6e","hex":"6a3866d70748b84f49ba52e6966f66952a8b72923d688cea75f4795ebda19bbe67b5cfee4b244003e964d91dfb2751a9fadc7d8a4d28f7eb8c6e","type":"nulldata"}},{"value":0.00768856,"n":1,"scriptPubKey":{"asm":"OP_DUP OP_HASH160 de1607744008a3edeabae06365a9aa2b131d5dc2 OP_EQUALVERIFY OP_CHECKSIG","hex":"76a914de1607744008a3edeabae06365a9aa2b131d5dc288ac","reqSigs":1,"type":"pubkeyhash","addresses":["1MFHQCPGtcSfNPXAS6NryWja3TbUN9239Y"]}}],"blockhash":"000000000000000000a6dae597c89af47a3f3028dff3875244cc3695fef6717a","confirmations":321,"time":1508089538,"blocktime":1508089538}', true);
    }

    protected function getEnhancedSend2() {
        return json_decode('{"hex":"","txid":"a13efa00507c51d52a4e7638a2e65674d9f271de1533a0eba4845876b90b41bf","hash":"a13efa00507c51d52a4e7638a2e65674d9f271de1533a0eba4845876b90b41bf","size":249,"vsize":249,"version":1,"locktime":0,"vin":[{"txid":"c2d129cbcead1843acf8e5a98bf135b2bd2990112d18b462272fbf1daf45cea4","vout":2,"scriptSig":{"asm":"3045022100b7d7800a40e6b0cfae0ebd30bbcac608ff49c83d6fea59fb46bddb085c2cdd140220761a3ad2b4d9a4ce5fe0d8f5838040c988caa9bbe1ff2e67451b67a2fa417278[ALL] 03920354646bdc4763305fc841034d2d31f68c6bbb244e3ecb1dbe55f74841c278","hex":"483045022100b7d7800a40e6b0cfae0ebd30bbcac608ff49c83d6fea59fb46bddb085c2cdd140220761a3ad2b4d9a4ce5fe0d8f5838040c988caa9bbe1ff2e67451b67a2fa417278012103920354646bdc4763305fc841034d2d31f68c6bbb244e3ecb1dbe55f74841c278"},"sequence":4294967295}],"vout":[{"value":0,"n":0,"scriptPubKey":{"asm":"OP_RETURN ced9973cc976675112cfa8cb5472ab9da3fc00e06e7b793c7ad6782a2ef0641e4e893473dc0c3c659ff0e59b4791","hex":"6a2eced9973cc976675112cfa8cb5472ab9da3fc00e06e7b793c7ad6782a2ef0641e4e893473dc0c3c659ff0e59b4791","type":"nulldata"}},{"value":0.01299141,"n":1,"scriptPubKey":{"asm":"OP_DUP OP_HASH160 4158821d0e886daeb5f69508bf0e0b8d8fb41bc8 OP_EQUALVERIFY OP_CHECKSIG","hex":"76a9144158821d0e886daeb5f69508bf0e0b8d8fb41bc888ac","reqSigs":1,"type":"pubkeyhash","addresses":["16xWx8Zgn52aMdNyk8TXqjq3gwqXZcSCxj"]}}],"blockhash":"000000000000000000862af07dfed8c50a0492424dc4824296d04fcc0ea2dd84","confirmations":2,"time":1508265525,"blocktime":1508265525}', true);
    }
